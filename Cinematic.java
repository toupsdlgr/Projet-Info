...
public class Cinematic extends Particles{
	...
	public Cinematic(int n,double[] masse,double[][] position, double[][] position2, double[][] vitesse, double[][] vitesse2, double[][] acceleration, double[][] acceleration2, int i, double delta,double g) {
